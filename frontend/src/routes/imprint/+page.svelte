<div class="content">
	<p>
		...
		Zürich 8005<br />
		Schweiz<br />
		<strong>E-Mail</strong>: info@reviveit.ch<br /><br />
		...
		oder durch technische Störungen entstanden sind, werden ausgeschlossen.<br /><br />
		...
		erfolgen auf eigene Gefahr des jeweiligen Nutzers.<br /><br />
		...
		Website, gehören ausschliesslich ReviveIT oder den speziell genannten Rechteinhabern. Für die Reproduktion
		jeglicher Elemente ist die schriftliche Zustimmung des Urheberrechtsträgers im Voraus einzuholen.<br
		/><br />
