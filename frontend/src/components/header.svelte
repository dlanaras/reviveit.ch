...
{#if isMobile(innerWidth)}
	<button on:click={flip} aria-label="Navbar Button">
		{#if hideMobileNav}
			...
			>
				<g>
					<rect fill="#fff" height="1" width="11" x="0.5" y="5.5" class="top" />
					<rect fill="#fff" height="1" width="11" x="0.5" y="2.5" class="middle" />
					<rect fill="#fff" height="1" width="11" x="0.5" y="8.5" class="bottom" />
				</g>
			</svg>
		{:else}
			<svg
